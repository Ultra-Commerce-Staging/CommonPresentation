...
/**
 * Implementation of {@link AbstractUltracommerceTempalateResolver} that is used if the template you are resolving are in the deployed
 * {@code webapp} folder. Generally the templates would be in {@code WEB-INF}
 * 
 * @author Jay Aisenbrey (cja769)
 *
 */
public class UltracommerceThemeAwareTemplateResolver extends AbstractUltracommerceTemplateResolver {

    @Override
    public UltracommerceTemplateResolverType getResolverType() {
        return UltracommerceTemplateResolverType.THEME_AWARE;
    }
