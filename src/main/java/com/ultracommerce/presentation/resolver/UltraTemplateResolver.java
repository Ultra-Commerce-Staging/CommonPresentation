 ...
 *
 */
public interface UltracommerceTemplateResolver {
    ...
    /**
     * @return The order in the list of all {@code UltracommerceThymeleafTemplateResolver} that this resolver should run
     */
