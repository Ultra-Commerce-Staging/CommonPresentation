...
/**
 * Implementation of {@link AbstractUltracommerceTemplateResolver} that is used if the templates that need to be resolved
 * are not under {@code WEB-INF} but are instead somewhere else on the classpath
 * 
 * @author Jay Aisenbrey (cja769)
 *
 */
public class UltracommerceClasspathTemplateResolver extends AbstractUltracommerceTemplateResolver {

    @Override
    public UltracommerceTemplateResolverType getResolverType() {
        return UltracommerceTemplateResolverType.CLASSPATH;
    }
