...
/**
 * The base object for making a new piece of markup using {@link UltracommerceTemplateElement}s.
 * see {@link UltracommerceTemplateContext#createModel()} to create an object that conforms to this interface for you
 * 
 * @author Jay Aisenbrey (cja769)
 * @see {@link UltracommerceTemplateContext#createModel()}
 */
public interface UltracommerceTemplateModel {

    /**
     * Add a new child element to the model. Adding elements conserves order in which they were added
     */
    public void addElement(UltracommerceTemplateElement elem);
