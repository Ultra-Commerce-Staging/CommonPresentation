...
/**
 * Default implementation of {@link UltracommerceVariableModifierAttrProcessor} that provides some defaults
 * 
 * @author Jay Aisenbrey (cja769)
 *
 */
@Deprecated
public abstract class AbstractUltracommerceVariableModifierAttrProcessor implements UltracommerceVariableModifierAttrProcessor {
