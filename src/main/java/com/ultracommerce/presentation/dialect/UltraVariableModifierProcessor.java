 ...
 */
@Deprecated
public interface UltracommerceVariableModifierProcessor extends UltracommerceProcessor {
     ...
     * {@link #useGlobalScope()}
     */
    public Map<String, Object> populateModelVariables(String tagName, Map<String, String> tagAttributes, UltracommerceTemplateContext context);
}
