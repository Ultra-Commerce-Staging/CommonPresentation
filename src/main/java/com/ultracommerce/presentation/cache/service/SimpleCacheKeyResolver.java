...
public class SimpleCacheKeyResolver implements TemplateCacheKeyResolverService {
     ...
     */
    @Override
    public String resolveCacheKey(String tagName, Map<String, String> tagAttributes, String documentName, Integer lineNumber, UltracommerceTemplateContext context) {
    ...
    protected String getStringValue(String attrName, Map<String, String> tagAttributes, boolean removeAttribute, UltracommerceTemplateContext context) {
